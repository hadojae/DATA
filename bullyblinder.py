...
#hadojae
#whale.py v0.2 ++ functions and less dumb stuff than the last one, but still some dumb stuff probably :)

# remember to set your interface properly otherwise checksum errors may eat your face
...
def obfuscation_multimail(page, current_url):
    ...
    for link in soup.findAll("a"):
        ...
        if link is None:
            continue
        if not re.search("365|goog|webmail|other|gmail|yah|outlook|liamg|oohay|kooltuo|office", link, re.IGNORECASE):
            continue
